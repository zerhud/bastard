builddir := make_build
tests_excluded_for_clang := "absd/callable jiexpr/math jiexpr/objects jiexpr/methods jiexpr/logic ast_graph/query ast_graph/select ast_graph/gcconly_build_graph"
